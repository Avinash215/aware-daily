...
export const GLOSSARY = Object.freeze([
  ...
  },
  {
    ...
    meaning: 'Possible senses. Request: An earnest call for help, support or action; to make that call. Legal review: A request for a higher court or other reviewing authority to reconsider a decision; to make that request. Attraction: A quality that draws interest or liking; to interest or attract someone.',
    usage: 'Hypothetical examples. Request: Officials could appeal for calm. Legal review: A company could appeal a ruling if it believes the judge applied the wrong legal standard. Attraction: A quieter route could appeal to walkers.',
  },
  {
    id: 'arbitration',
    term: 'arbitration',
  ...
  },
  {
    ...
    term: 'autonomous',
    aliases: [],
    meaning: 'Possible senses. Self-government: Able to govern or make decisions independently in some matters, without necessarily being a separate country. Task control: Able to carry out tasks without continuous human direction; an autonomous vehicle may operate only under specified conditions.',
    usage: 'Hypothetical examples. Self-government: An autonomous region could set its own education policy while remaining part of a country. Task control: A shuttle service could use autonomous vehicles only on mapped routes.',
  },
  {
  ...
  },
  {
    ...
    meaning: 'Possible senses. Belief: A firmly held view or strong sense of certainty, not proof that the view is correct. Criminal law: A formal finding of guilt for an offence, following a trial or an accepted guilty plea. Convicted means found guilty in this legal sense, not simply convinced of a belief.',
    usage: 'Hypothetical examples. Belief: A campaigner could speak with conviction about equal access. Criminal law: A person convicted of fraud could face a prison sentence, depending on the offence and local law.',
  },
  {
    id: 'copyright',
    term: 'copyright',
  ...
  },
  {
    ...
    term: 'inference',
    aliases: ['inferences'],
    meaning: 'Possible senses. Reasoning: Drawing a conclusion from evidence or patterns rather than direct observation, or the conclusion itself; it may be mistaken. Model use: Applying a trained machine-learning model to input to produce an output, rather than training it. This does not guarantee that the output is correct.',
    usage: 'Hypothetical examples. Reasoning: Analysts could draw an inference from shipping records but need more evidence to confirm it. Model use: A trained model could perform inference on a new image to predict what it shows.',
  },
  {
    id: 'injunction',
    term: 'injunction',
  ...
  },
  {
    ...
    meaning: 'Possible senses. Request: To ask earnestly or urgently, sometimes by begging. Criminal plea: To formally answer a criminal charge, usually by stating guilty or not guilty. Legal argument: To present a claim or defence; a pleading can be a formal statement of a party\'s case. Reason or excuse: To offer a reason in defence of an action.',
    usage: 'Hypothetical examples. Request: A family could be pleading for help. Criminal plea: A defendant could plead not guilty. Legal argument: A lawyer could plead a client\'s case. Reason or excuse: A late applicant could plead illness as the reason for the delay.',
  },
  {
    id: 'portfolio',
    term: 'portfolio',
  ...
  },
  {
    ...
    term: 'reserves',
    aliases: [],
    meaning: 'Possible senses. Finance: Money or assets held for future needs. Resources: Supplies or strength kept available, or natural resources estimated to be recoverable. Military: Personnel or forces held ready for service or later deployment. Nature: Areas set aside to protect wildlife or habitats. Sport: Players available as replacements or in a backup team. Verb: Sets something aside for a person or purpose, or keeps a right or decision for later.',
    usage: 'Hypothetical examples. Finance: A central bank could hold gold reserves as a safeguard. Resources: A survey could estimate recoverable oil reserves. Military: An army could call up its reserves. Nature: New reserves could protect wetlands. Sport: A coach could select players from the reserves. Verb: A draft policy might say that the council reserves two seats for residents and reserves the right to review the arrangement.',
  },
  {
    id: 'restructuring',
    term: 'restructuring',
  ...
  },
  {
    ...
    term: 'sanctions',
    aliases: ['sanction'],
    meaning: 'Possible senses. Penalty: A restriction or punishment, often used to influence behaviour through trade, travel or financial limits; as a verb, to impose a penalty. Approval: Official permission or authorisation; as a verb, to give that approval. Both sanction and sanctions can be nouns or verbs, so spelling alone does not select the sense.',
    usage: 'Hypothetical examples. Penalty: Proposed sanctions could freeze assets while allowing essential food deliveries. Approval: Lawmakers could sanction a project. Approval: A rule might state that the committee sanctions each proposal before work begins.',
  },
  {
    id: 'sediment',
    term: 'sediment',
